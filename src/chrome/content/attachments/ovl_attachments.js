...
(function() {
	...
	ovl_attachments.origFunctions.onShowSaveAttachmentMenuMultiple = onShowSaveAttachmentMenuMultiple;
...
(function() {
	// Keep a reference to the original function.
	ovl_attachments.origFunctions.onShowSaveAttachmentMenuSingle = onShowSaveAttachmentMenuSingle;
...
(function() {
	// Keep a reference to the original function.
	ovl_attachments.origFunctions.goUpdateAttachmentCommands = goUpdateAttachmentCommands;
	
	// Override a function.
	goUpdateAttachmentCommands = function() {
		
		// Execute original function.
		var rv = ovl_attachments.origFunctions.goUpdateAttachmentCommands.apply(null, arguments);
		ovl_attachments.displayCardBookMenu();
...
(function() {
	// Keep a reference to the original function.
	ovl_attachments.origFunctions.onShowAttachmentItemContextMenu = onShowAttachmentItemContextMenu;
	
	// Override a function.
	onShowAttachmentItemContextMenu = function() {
		
		// Execute original function.
		var rv = ovl_attachments.origFunctions.onShowAttachmentItemContextMenu.apply(null, arguments);
		ovl_attachments.displayCardBookMenu();
